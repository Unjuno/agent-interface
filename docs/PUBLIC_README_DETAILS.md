# Retained extended public README material

This file retains the extended material that previously lived in the repository root README. It was moved out of the public entry point so the root README can remain concise. The retained material below is unchanged from the root README at the split point.
