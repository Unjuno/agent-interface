Latest OpenTTD effect diagnosis: the frozen v6 formal finish result remains unavailable, but263 continuous source-pinned observer records independently prove a stable partial result. At record91 A-to-B tiles977..979 become owned road and remain so for the final172 records; B-to-C tiles1043/1107 remain empty, forbidden/surrounding checks pass and hard success is false. The model repeats the same A-to-B drag on turns5,9,11 and never attempts B-to-C. New bounded path evidence measures3,628 changed crop pixels on the first drag versus250/451 on repeats; pixel delta is not semantic scoring. Windows/WSL audits pass. Next run this effect evidence live on a changed preregistered case and compare repeated work, boundaries, correctness and actual tokens. See research/live_control/OPENTTD_EFFECT_POSTHOC_V1.md. Full live-tempo/domain goal stays open.
