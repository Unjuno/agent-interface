...
out=Path('results-local/public-observe-review-live-01').resolve()
out.mkdir(exist_ok=False)
r,w=os.pipe()
server=subprocess.Popen(['Xvfb','-displayfd',str(w),'-screen','0','640x480x24','-nolisten','tcp'],pass_fds=(w,),stdout=subprocess.DEVNULL,stderr=subprocess.PIPE)
os.close(w)
d=None
try:
