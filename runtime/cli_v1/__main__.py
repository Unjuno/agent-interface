...
def main() -> int:
    ...
    read.add_argument('--retention-timings', action='store_true', help='measure retention phases; requires --run-directory')
    ...
    run.add_argument('--retention-timings', action='store_true', help='measure retention phases; requires --run-directory')
