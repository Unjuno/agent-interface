"""Fail-closed independent raw-only byte-binding audit for Issue #3809."""
...
def adjudicate(files: dict[str, bytes], preflight_errors: list[str],
    ...
    """Fail closed before parsing delivery semantics or invoking mutation checks."""
...
def main() -> int:
    ...
    result = {
        "schema": "agent-interface/issue-3809-audit-result-v1",
        "issue": 3809,
