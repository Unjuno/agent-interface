...
OUT = HERE / "results/mindustry-receipt-revalidation-followup-01"
...
def main():
    ...
    sources = [
        "benchmark_discovery/run_mindustry_receipt_revalidation_followup_live_v1.py",
    ...
    plan = {
        "name": "mindustry-receipt-revalidation-followup-01",
