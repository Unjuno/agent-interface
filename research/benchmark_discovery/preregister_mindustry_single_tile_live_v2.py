...
PRIOR_FAILURE = HERE / "results/mindustry-single-tile-live-01/failure.json"
SOURCES = [
    "preregister_mindustry_single_tile_live_v2.py", "run_mindustry_single_tile_live_v2.py",
    ...
    "mindustry_conveyor_selection_oracle_v1.py", "mindustry_palette_candidate_responder_v2.txt",
    "mindustry_palette_binding_v2.py", "mindustry_world_candidate_responder_v2.txt", "mindustry_world_hover_receipt_v1.py",
    ...
    "live_control/anchor_evidence_responder_v1.txt", "live_control/bounded_visual_target_contract_schema_v2.json",
    "live_control/bounded_visual_target_contract_v2.py", "live_control/compact_hover_sheet_v2.py",
...
def main():
    ...
    plan = {
        ...
        "study": "mindustry-single-tile-live-02", "base_main": "cacf6dcd098b5233e839a14813af33654f1430b0",
        "model": "gpt-5.6-luna", "reasoning_effort": "low", "model_calls_max": 4,
        "task": task,
        "policy": ("use mutually exclusive direct/probe/coordinate-free candidate results and reject a palette point farther "
        ...
        "sources": {name: sha(HERE.parent / name) if name.startswith("live_control/") else sha(HERE / name)
                    for name in SOURCES},
        "scope": ("one fresh fixed-screen Linux/X11 Mindustry task after a retained schema-valid/validator-invalid zero-input v1; "
