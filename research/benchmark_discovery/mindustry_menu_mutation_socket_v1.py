...
def spawn(args,**kwargs):
 args=list(args);i=next(i for i,a in enumerate(args) if str(a).endswith('interactive_v27.py'));args[i]=str(HERE/'mindustry_menu_mutation_fixture_v1.py');return original(args,**kwargs)
