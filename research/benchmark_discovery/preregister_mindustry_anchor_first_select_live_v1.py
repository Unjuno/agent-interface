"""Freeze one Mindustry anchor-first selection allocation before execution."""
import hashlib
import json
...
OUT = HERE / "results/mindustry-anchor-first-select-live-01"
REFERENCE = HERE / "results/mindustry-bend-v2-self-use-01/004.png"
SOURCES = [
    "preregister_mindustry_anchor_first_select_live_v1.py",
    "run_mindustry_anchor_first_select_live_v1.py",
    ...
    "live_control/openttd_compact_hover_sheet_v1.py",
]
...
def main():
    ...
    plan = {
        ...
        "study": "mindustry-anchor-first-select-live-01",
        ...
        "scope": ("one fixed-layout paused Mindustry palette selection task using requested Luna-low "
