...
from mindustry_world_target_contract_v2 import validate as validate_world
...
def main():
    ...
    try:
        ...
        world_candidate_model = model("model-world-candidate",
            ...
            selected_path, "../benchmark_discovery/mindustry_world_candidate_responder_v3.txt",
            "bounded_visual_target_contract_schema_v3.json")
        ...
        world_receipt_model = model("model-world-receipt", plan["task"] +
            ...
            "../benchmark_discovery/mindustry_world_target_responder_v2.txt",
