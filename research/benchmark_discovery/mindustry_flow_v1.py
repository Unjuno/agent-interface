...
def main():
    ...
    plan=json.loads((HERE/'mindustry_flow_plan_v1.json').read_text())
    ...
    sources=[Path(__file__),HERE/'mindustry_flow_plan_v1.json',*sorted((HERE/'mindustry_flow_mod_v1').rglob('*')),
    ...
    for case in plan['cases']:
        ...
        try:
            ...
            shutil.copytree(HERE/'mindustry_flow_mod_v1',data/'mods/interface-flow-calibration')
