...
if stage=='prepare':
 dump('plan.json',{'scope':'live bounded known-menu intent; single click after new observation and exact patch check','sources':{n:hashlib.sha256((HERE/n).read_bytes()).hexdigest() for n in ('live_menu_intent_v1.py','focus_decision_view_v2.py','mindustry_socket_v1.py','menu_intent_guard_v1.py')}})
