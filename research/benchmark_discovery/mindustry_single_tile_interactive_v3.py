"""Receipt admission with unavailable-binding and resize fault controls."""
import argparse
import contextlib
import hashlib
import json
...
from mindustry_receipt_session_v2 import Backend, suite
...
def main():
    ...
    sources = [HERE / name for name in ("mindustry_single_tile_interactive_v3.py",
