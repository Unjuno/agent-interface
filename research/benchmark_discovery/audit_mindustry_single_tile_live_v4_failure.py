...
OUT = HERE / "results/mindustry-single-tile-live-04"; ROOT = OUT / "live-changed-geometry"
...
def main():
    ...
    assert any("schema must have a 'type' key" in json.dumps(row) for row in failed_raw)
    ...
    audit = {"passed": True, "decision": "RETAIN_VERIFIED_WORLD_PROBE_MISSING_SCHEMA_TYPE",
