...
def main():
 ...
 if r.get('task')!='LOCAL-SYSTEM1-ROUTE-DECISION-COST-20260917-002': errs.append('task')
 if r.get('scientific_seed')!=89220260917 or r.get('sklearn_seed')!=(89220260917 % 2**32): errs.append('seed_contract')
