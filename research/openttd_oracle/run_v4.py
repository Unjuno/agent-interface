...
def main():
    ...
    sources=[Path(__file__).resolve(),HERE/'score.py',HERE/'plan.json',*sorted((HERE/'script_v4').glob('*')),
    ...
    for seed in manifest['plan']['seeds']:
        ...
        try:
            ...
            shutil.copytree(r/'share/games/openttd/game',data/'game');shutil.copytree(HERE/'script_v4',data/'game/interface_oracle')
