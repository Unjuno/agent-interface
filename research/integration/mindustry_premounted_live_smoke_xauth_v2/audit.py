#!/usr/bin/env python3
"""Independent raw-result audit for Issue #4454. Does not import study.py."""
...
EXPECTED_OUTCOME="PASS_MINDUSTRY_PREMOUNTED_LIVE_SMOKE_XAUTH_SCOPED"
...
def audit(root: Path):
 ...
 checks={
  ...
  'xauthority': r.get('xauthority',{}).get('exists_at_launch') is True and r.get('xauthority',{}).get('mode')=='0o600' and r.get('env_subset',{}).get('XAUTHORITY')==r.get('xauthority',{}).get('path') and r.get('parent_xauthority')!=r.get('xauthority',{}).get('path'),
