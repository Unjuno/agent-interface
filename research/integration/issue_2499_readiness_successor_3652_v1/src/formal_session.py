...
def main():
    root = Path(tempfile.mkdtemp(prefix="mixed-formal-2499-3652-"))
    ...
    try:
        ...
        calc, cw, ident = launch(["libreoffice","--norestore","--nolockcheck","--nofirststartwizard","--calc",
        ...
        out.update({"allocation_id":"issue2499-readiness-successor-3652-formal-01","issue":3652,
