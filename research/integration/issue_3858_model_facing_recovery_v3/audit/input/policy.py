"""Frozen policy implementations carried forward from #3204 v2."""
POLICIES = ("TYPED_EPOCH_AWARE_COMPOSER", "LATEST_CHANNEL_WINS", "BEST_EFFORT_MERGE", "EPOCH_REJECT_ONLY")
...
def compose(scenario, policy, max_skew_ms):
    ...
    if policy == "TYPED_EPOCH_AWARE_COMPOSER":
        ...
        return {"disposition": "COMPOSE_SKEWED_CONTEXT" if skew else "COMPOSE_COHERENT", "bundle": rows, "authority": False}
    ...
    if policy == "LATEST_CHANNEL_WINS":
        ...
        return {"disposition": "COMPOSE_LATEST_PER_CHANNEL", "bundle": list(latest.values()), "authority": False}
    if policy == "BEST_EFFORT_MERGE":
        return {"disposition": "COMPOSE_ALL_AVAILABLE", "bundle": rows, "authority": False}
