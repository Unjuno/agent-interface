...
def audit(evidence, repo, freeze_path):
    ...
    return {"decision": decision, "scope": "one GTK/Xvfb no-input capture-validity calibration",
            ...
            "stage_transition_comparisons": transition_results, "identities": identities,
