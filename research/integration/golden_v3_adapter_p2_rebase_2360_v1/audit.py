...
def main():
    ...
    assert result["status"] == "PASS_GOLDEN_V3_ADAPTER_P2_REBASE_SCOPED"
    assert result["cases"] == 5
    assert result["nested_runtime_failed_preserved_as_partial"]
    ...
    print("P2_REBASE_AUDIT_PASS cases=5 source_blobs=2 authority_grants=0")
