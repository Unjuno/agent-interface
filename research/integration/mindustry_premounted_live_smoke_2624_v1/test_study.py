...
class T(unittest.TestCase):
 def test_git_blob(self):
  with tempfile.TemporaryDirectory() as d:
   p=Path(d)/'x';p.write_bytes(b'hello');self.assertEqual(study.git_blob(p),hashlib.sha1(b'blob 5\0hello').hexdigest())
 def test_expected_identity_constants(self):
  self.assertEqual(study.EXPECTED['jar']['bytes'],87022576);self.assertEqual(study.EXPECTED['jar']['sha256'],'7f210295dfffb4c17b582b27bab41f4dde83f557f00f0877572fdac943f40539')
