# Modified 2026-09-25: reuse the verified hash state only within one read_pending call.
# Derived from upstream Git blob ea72c166c2cea511ea91031dfbb14563fe4e3245; Apache-2.0.
...
def read_pending(path, *, stream_id, cursor=None, max_records=32, max_bytes=1048576):
    ...
    # Private to this call: every invocation still validates the current prefix.
