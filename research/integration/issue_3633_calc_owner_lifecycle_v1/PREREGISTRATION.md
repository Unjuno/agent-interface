...
Allocation ID: `issue3644-calc-owner-lifecycle-formal-01`.
...
4. Reap the direct launcher if it was still the runner's child, then terminate
   the sentinel and Xvfb individually; record wait statuses and X socket
