...
if raw.get("allocation_id")!="issue2499-readiness-successor-3633-formal-01" or raw.get("issue")!=3633: errors.append("allocation identity mismatch")
...
required={"session_setup","observe","focus_drift","stale_admission","modal_transition","modal_recovery",
...
apps=raw.get("apps",{})
if set(apps)!={"inkscape","calc","chromium"}: errors.append("app identity set mismatch")
...
if raw.get("transition_gate")!="PASS_MIXED_APP_READINESS_TRANSITIONS_SCOPED":
    errors.append("transition gate not PASS")
...
result={"decision":"PASS_READINESS_TRANSITIONS_AUDITED" if not errors else "HOLD_READINESS_TRANSITIONS_AUDIT",
