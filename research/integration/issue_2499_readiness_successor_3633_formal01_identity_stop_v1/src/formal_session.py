...
def main():
    root = Path(tempfile.mkdtemp(prefix="mixed-formal-2499-3633-"))
    ...
    env = os.environ.copy(); env.update(DISPLAY=DISPLAY,
        ...
        XAUTHORITY=str(root/"Xauthority"), SAL_USE_VCLPLUGIN="gen", GDK_BACKEND="x11")
    xvfb=None; wm=None
    ...
    try:
        ...
        inkscape, iw, ident = launch(["inkscape","--no-splash","--new"], env,"inkscape")
        ...
        out.update({"allocation_id":"issue2499-readiness-successor-3633-formal-01","issue":3633,
