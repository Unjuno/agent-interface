...
- [Audit v2-01 provenance STOP](audit-v2/STOP-01.md) is preserved; the corrected [audit successor report](audit-v2-successor-02/REPORT.md) independently binds the recovery hashes to the actual attempt directory using read-only evidence mounts.
