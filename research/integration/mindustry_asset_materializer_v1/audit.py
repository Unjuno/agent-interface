...
recomputed={
 ...
 'files':good['published_files']==['MANIFEST.json',ids['save']['name'],ids['jar']['name']],
...
out={'schema':'mindustry_asset_materializer_audit_v1','passed':all(recomputed.values()),'checks':recomputed,'decision':r['decision']}
