"""GTK/X11 disposable fixture copied from main blob e4cb3876769e69efd52d684fcd146bdc4233e385."""
import argparse
import json
...
def main():
    ...
    args.meta.write_text(json.dumps({"window_id": xid, "entry_window_id": entry.get_window().get_xid(),
                                     "toolkit": "gtk3"}, sort_keys=True) + "\n", encoding="utf-8")
    Gtk.main()
