...
Status: PASS_SYNTHETIC_LIFECYCLE_ADAPTER_TRACE_SCOPED (pending native/container workflow)
...
The workflow also runs the same audit in python:3.12-slim with git installed so
the four pinned current-main source blobs can be recomputed.