...
- Predecessor #3633 formal-01 stopped before transitions because the runner used an empty Xauthority file; raw result is retained under the predecessor path and is not copied or modified here.
