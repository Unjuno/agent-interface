...
if plan["seed"]!=284936 or plan["maximum_host_model_calls"]!=17 or plan["retry"] is not False:
...
preflight_test=json.loads((Path(__file__).resolve().parent/
    "evidence/preflight-parser-test/run-02/preflight-parser-test-result.json").read_text())
