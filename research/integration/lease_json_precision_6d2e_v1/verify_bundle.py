...
PARTS = ['evidence.part00.b64', 'evidence.part01.b64', 'evidence.part02.b64', 'evidence.part03.b64', 'evidence.part04.b64', 'evidence.part05.b64', 'evidence.part06.b64', 'evidence.part07.b64']
...
def main() -> int:
    ...
    with archive.open("wb") as dst:
        for name in PARTS:
            p = here / name
            data = base64.b64decode(p.read_text(encoding="ascii"), validate=False)
            dst.write(data)
            h.update(data)
            total += len(data)
    digest = h.hexdigest()
