...
class CurveAuditContract(unittest.TestCase):
    ...
    def test_digest_compare_normalizes_case(self):
        ns={"__name__":"test_module"}
        exec(compile(TREE,str(ROOT/"audit_curves.py"),"exec"),ns)
        sample="A1"*32
        self.assertTrue(ns["matches_sha"](sample,sample.lower()))
        self.assertTrue(ns["matches_sha"](sample.lower(),sample))
        self.assertFalse(ns["matches_sha"](sample,"B2"*32))
    def test_copied_predecessor_file_hashes(self):
        import hashlib
        pins={"predecessor_raw_stdout.txt":"F185E4DEAB4B19BA4B146C723CB03C1078DB53307DCBF1C2D856D9C5728C320E","predecessor_audit_stdout.txt":"012AE716296C96D33C4D8A570748E46ED12EC54263F18C27CC30AF439E096708","predecessor_runner.py":"1FE0A27E045085508478FCCEA1DAAF3096BA0F2775A6A9F8C1A693536579554F","predecessor_audit.py":"82AD70186A9FAEB59350B8CA1C9E951101D40C1C99DBA6EBB6BE4519187F800F"}
        for name,pin in pins.items():
            actual=hashlib.sha256((ROOT/name).read_bytes()).hexdigest()
            self.assertEqual(actual.lower(),pin.lower(),name)
