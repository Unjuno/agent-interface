...
if r.get("allocation")!="needle-lora-3441-pilot-04d-corrected-base-20260926-01":errors.append("allocation")
if r.get("parameters",{}).get("base_pretrain_steps")!=400:errors.append("base_pretrain_steps")
if r.get("parameters",{}).get("adapter_steps")!=120:errors.append("adapter_steps")
