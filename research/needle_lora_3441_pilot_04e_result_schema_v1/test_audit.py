...
def fixture():
 ...
 rows={"routed":{},"shared":{}}
 data_hash={}
 for skill,ds,flip0,flip1 in (("A",5924,False,False),("B",5925,True,False),("C",5926,False,True)):
 ...
 return {"allocation":"needle-lora-3441-pilot-04e-result-schema-20260926-01","parameters":{"seed":5920,"base_pretrain_steps":400,"adapter_steps_per_fit":120},
