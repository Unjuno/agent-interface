...
def main() -> int:
    ...
    try:
        ...
        result["xkb_extension"] = conn.has_extension("XKEYBOARD")
        if not result["xkb_extension"] or not conn.has_extension("XTEST"):
            raise RuntimeError("required XKEYBOARD/XTEST extension missing")
