...
Status: A1 revision 2 protocol, 2026-09-13 JST. Source and parameters are snapshotted
in `results/frozen-a1r2/freeze.json` before either new fresh replicate. Revision 1
stopped on an Inkscape baseline failure; it remains INVALID and is never pooled
with this evaluation. Its original protocol and source remain in `frozen-a1/`.
...
- Fresh evaluation: two independently launched replicates, 12 pairs/app each,
  seeds 290101–290112 and 390101–390112, **24 pairs/app, 96 pairs total**. These seeds
