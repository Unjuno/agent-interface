"""Independent-auditor corruption tests for Issue #4505; CPU only, no training."""
...
def fixture():
 ...
 rows={"routed":{},"shared":{}}
 data_hash={}
 for skill,ds,flip0,flip1 in (("A",777735,False,False),("B",777736,True,False),("C",777737,False,True)):
 ...
 return {"allocation":"needle-lora-3441-pilot-04f-seed-replication-20260926-01","parameters":{"seed":777731,"base_pretrain_steps":400,"adapter_steps_per_fit":120},
