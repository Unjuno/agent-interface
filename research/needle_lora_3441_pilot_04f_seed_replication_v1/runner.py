"""Result-schema-regression successor for Issue #4492; synthetic local CUDA only."""
...
def parameter_record():
    """Pure, construction-testable JSON parameter summary; no training or CUDA needed."""
    return {
        "seed": SEED, "base_pretrain_steps": BASE_STEPS,
        "adapter_steps_per_fit": ADAPTER_STEPS,
        "features": FEATURES, "hidden": HIDDEN, "classes": CLASSES, "rank": RANK,
...
def main():
    ...
    result = {
        "allocation": "needle-lora-3441-pilot-04f-seed-replication-20260926-01",
