...
REPO = HERE.parents[1]
SOURCE = REPO / "results-local/doom/map01-policy-invalidation-v24-live-01"
TARGET = HERE / "results/map01-policy-invalidation-v24-live-01"
ROI = (440, 585, 535, 635)
...
def main():
    ...
    manifest = {
        "schema": "map01-policy-invalidation-v24-retention-v1",
        "allocation_id": "map01-policy-invalidation-v24-live-01",
