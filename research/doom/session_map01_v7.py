"""MAP01 v7 with a hash-bound setup fixture and unchanged live OS-input control."""
...
def main():
    ...
    if args.fixture_out is not None and args.load_fixture_manifest is not None:
        parser.error("fixture creation and fixture loading are mutually exclusive")
