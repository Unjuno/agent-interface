"""Retain the first frozen v26 integration allocation without transformation."""
import hashlib
import json
...
REPO = HERE.parents[1]
SOURCE = REPO / "results-local/doom/map01-persistent-planner-v26-live-01"
TARGET = HERE / "results/map01-persistent-planner-v26-live-01"
...
def main():
    ...
    manifest = {
        "schema": "map01-persistent-planner-v26-retention-v1",
        "allocation_id": "map01-persistent-planner-v26-live-01",
        "source": str(SOURCE),
