...
submit("enter-combat",[{"op":"hold","keys":["Up","Shift_L"],"duration_ms":5000},
 {"op":"hold","keys":["Right"],"duration_ms":700},{"op":"hold","keys":["Up","Shift_L"],"duration_ms":3500}])
for i in range(4):submit(f"exposed-{i}",[{"op":"coast","duration_ms":5000,"sample_ms":500}])
