"""MAP01 controller with immediate, running and exact-program-bound action validation."""
import argparse
import atexit
...
class DoomRunningActionMonitor:
    ...
    def observe(self, observation, decided_ns=None):
        snapshot = build_action_snapshot(
            observation, self.contract, self.readers)
...
def session_command(args, runtime):
    return [sys.executable, str(HERE / "session_map01_v9.py"),
