"""Hash the copied first v39 coast-liveness outcome file by file."""
import hashlib
import json
...
def main():
    ...
    value = {"schema": "map01-v39-first-outcome-retention-v1",
             "allocation_id": ROOT.name,
             "source": "results-local/doom/map01-v39-coast-liveness-live-01",
