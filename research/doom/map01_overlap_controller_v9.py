...
def main():
    ...
    process = subprocess.Popen([sys.executable, str(HERE / "session_map01_v5.py"),
    ...
    for index in range(args.iterations):
        ...
        prior_attacked=bool(decisions and any(command["action"] in
          ("fire","advance_fire","retreat_fire") for command in decisions[-1]["action"]["commands"]))
        if prior_attacked:
