...
def choose_pair(rows,min_gap_ns,max_gap_ns,target_gap_ns):
    ...
    _,_,pi,ci,prev,cur=min(candidates,key=lambda x:(x[1],x[0],x[2],x[3]));return prev,cur,pi,ci
def main():
