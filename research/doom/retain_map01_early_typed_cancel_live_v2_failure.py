"""Retain the first frozen v2 allocation failure without retry."""
import hashlib
import json
...
REPO = HERE.parents[1]
SOURCE = REPO / "results-local/doom/map01-early-typed-cancel-live-02"
TARGET = HERE / "results/map01-early-typed-cancel-live-02"
