...
root=HERE/'results/bounded-followup-02';root.mkdir(exist_ok=False)
names=['probe_bounded_followup_v2.py','stopped_transport_entry_v1.py','stopped_transport_fixture_v1.py',
