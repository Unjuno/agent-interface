...
class InputOwner:
    ...
    def _run(self):
        ...
        def invalid_focus(lease):
            ...
            actual=focus_id()
            if actual!=lease.expected_focus:
                self.records.append(dict(event='focus_mismatch_diagnostic',actual_focus=actual,
                    expected_focus=lease.expected_focus,valid_until_ns=lease.deadline,observed_ns=time.perf_counter_ns()))
