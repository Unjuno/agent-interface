"""Audit corrected exact programs, effects and releases for drag calibration."""
import hashlib
import json
...
def main():
    ...
    assert overall['model_calls'] == 0 and overall['source_sha256'] == sha(HERE / 'probe_openttd_drag_calibration_v2.py')
    rows = []
