...
plan={'scope':'fresh seed-991002 shifted-geometry OpenTTD fixed route with buffered process-scoped timing envelope',
      'arm':arm,
      'sources':{n:hashlib.sha256((HERE/n).read_bytes()).hexdigest() for n in ['timing_envelope_openttd_matched_supervisor_v5.py','timing_envelope_openttd_matched_driver_v5.py','timing_envelope_v1.py','timing_envelope_v2.py','openttd_proposal_schema_v5.py','openttd_finish_outcome_v1.py','model_pair_runner_v2.py','session_v22.py','openttd_contact_sheet_v1.py']},
      'max_turns':9,'seed_semantics':'byte-pinned seed-991002 save; target tiles 465..467; shifted viewport; closed toolbar',
      ...
      'initial_ui_state':'closed main toolbar; target viewport shifted by saved seed-991002 fixture'}
...
turns=[]
driver=subprocess.Popen(['wsl','-d','Ubuntu','--','python3',linux(HERE/'timing_envelope_openttd_matched_driver_v5.py'),arm],
