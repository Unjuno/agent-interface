...
R = H / 'results/redaction-cost-03'
R.mkdir(exist_ok=False)
ACTUAL = H / 'results/redacted-observation-02'
BINDING = json.loads((ACTUAL / 'private-audit-binding.json').read_text(encoding='utf-8'))
SOURCE = ACTUAL / 'runtime' / Path(BINDING['source_image']).name
...
names = ['measure_redaction_cost_v2.py', 'redacted_observation_v2.py']
dump('plan.json', {
