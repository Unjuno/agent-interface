...
HERE=Path(__file__).resolve().parent;root=HERE/'results/receipt-image-self-use-01'
...
(HERE/'results/receipt-image-self-use-audit.json').write_text(json.dumps(report,indent=2)+'\n');print(json.dumps(report,indent=2))
