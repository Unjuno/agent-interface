...
def main():
    ...
    names=['session_v10.py','session_v9.py','session_v8.py','session_v7.py','session_v6.py','session_v5.py','session_v4.py','input_owner_v5.py','executor_v3.py','lease.py','quiet_window.py']
    ...
    try:
        ...
        base={'op':'pointer_drag','points':[{'x':x+i,'y':y} for i in (0,12,24,36)],'duration_ms':300,'observe_at':[0,1,2]}
