...
root=HERE/'results/timing-envelope-openttd-01';root.mkdir(exist_ok=False)
def dump(name,value):
...
names=['timing_envelope_openttd_driver_v1.py','durable_submit_v4.py','append_checkpoint_v1.py','received_continuation_v1.py','received_exchange_v2.py','pointer_socket_entry_v1.py','event_socket_v11.py','model_pair_runner_v1.py','openttd_proposal_schema_v1.py','timing_envelope_openttd_supervisor_v1.py','timing_envelope_v1.py','timing_envelope_v2.py']
...
try:
 ...
 for index in range(1,7):
  ...
  assert all(s.get('op') in ('pointer_click','pointer_drag','observe') for s in steps)
