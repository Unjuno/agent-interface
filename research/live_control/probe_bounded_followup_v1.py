...
from bounded_followup_v1 import collect

HERE=Path(__file__).resolve().parent
root=HERE/'results/bounded-followup-01';root.mkdir(exist_ok=False)
names=['probe_bounded_followup_v1.py','stopped_transport_entry_v1.py','stopped_transport_fixture_v1.py',
       'bounded_followup_v1.py','receipt_image.py','stopped_client_v1.py','stopped_socket_v1.py','stopped_cursor_v1.py','stopped_scope_v1.py','executor_v8.py',
