...
label=sys.argv[1]
assert label in ('tier-abba-1-default','tier-abba-2-fast','tier-abba-3-fast','tier-abba-4-default')
...
names=['tier_calc_driver_v1.py','durable_submit_v4.py','append_checkpoint_v1.py','received_continuation_v1.py','received_exchange_v2.py','cause_servo_socket_v7.py','model_tier_runner_v1.py','calc_proposal_schema_v1.py','tier_calc_supervisor_v1.py']
