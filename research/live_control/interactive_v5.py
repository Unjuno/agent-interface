...
from session_v5 import Backend,suite
...
def main():
    ...
    try:
        hashes={}
        for path in [HERE/'interactive_v5.py',HERE/'session_v5.py',HERE/'input_owner.py',HERE/'executor_v3.py',HERE/'session_v4.py',HERE/'lease.py',HERE.parent/'observation_tiles/tile_transport.py',
        ...
        emit(dict(event='ready',app=args.app,goal=goal,operations=['submit','cancel','clock','finish']))
