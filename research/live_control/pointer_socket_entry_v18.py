"""Expose the model-point OpenTTD task behind socket11."""
...
ENTRY = HERE.parent / "openttd_task/interactive_l_point_target_v1.py"
domain = sys.argv.pop(1)
if domain != "openttd-point-target-v1":
    raise SystemExit("domain must be openttd-point-target-v1")
