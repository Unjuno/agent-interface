...
root=HERE/'results/auto-append-calc-01';root.mkdir(exist_ok=False)
def dump(name,value):
...
names=['auto_append_calc_driver_v1.py','durable_submit_v4.py','append_checkpoint_v1.py','received_continuation_v1.py','received_exchange_v2.py','cause_servo_socket_v7.py','model_pair_runner_v1.py','calc_proposal_schema_v1.py','auto_append_calc_supervisor_v1.py']
