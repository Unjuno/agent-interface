"""Durable OpenTTD L driver with one pre-planner transparency transition."""
...
study=sys.argv[2] if len(sys.argv)>2 else 'timing-envelope-openttd-l-05'
...
names=['timing_envelope_openttd_l_driver_v4.py','durable_submit_v4.py','append_checkpoint_v1.py','received_continuation_v1.py','received_exchange_v2.py','pointer_socket_entry_v8.py','event_socket_v11.py','openttd_finish_outcome_v1.py','session_v22.py']
