"""Freeze the OpenTTD L-objective negative and fixed-Astra episodes."""
import hashlib,json,os
from pathlib import Path
HERE=Path(__file__).resolve().parent;ROOT=HERE/'results/timing-envelope-openttd-l-01'
SOURCES=['preregister_openttd_l_v1.py','openttd_negative_finish_l_v1.py','openttd_finish_outcome_v1.py','timing_envelope_openttd_l_driver_v1.py','timing_envelope_openttd_l_supervisor_v1.py','timing_envelope_v1.py','timing_envelope_v2.py','openttd_proposal_schema_v5.py','model_pair_runner_v2.py','pointer_socket_entry_v8.py','session_v22.py','openttd_contact_sheet_v1.py']
...
plan={'study':'timing-envelope-openttd-l-01','status':'PREREGISTERED_BEFORE_EXECUTION','execution_order':['negative-control','fixed-astra'],
