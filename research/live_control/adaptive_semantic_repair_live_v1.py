...
def run_case(plan, root, ordinal, mode):
    ...
    report = {"schema": "adaptive-semantic-repair-live-case-v1",
    ...
    try:
        ...
        def final_revalidate(target):
            ...
            if not score["success"]: return {"status": "association_changed"}
...
def main():
    ...
    plan = json.loads((HERE / "adaptive_semantic_repair_live_v1_prereg.json").read_text())
    ...
    report = {"schema": "adaptive-semantic-repair-live-report-v1",
