...
def run_case(condition, plan):
    ...
    try:
        ...
        anchor_goal = ("Open the company finances window in this OpenTTD game" if condition == "positive" else
            "Open the airport construction toolbar in this OpenTTD game")
        anchor_model = base.model_call(
            root, "model-anchor-evidence", anchor_goal +
