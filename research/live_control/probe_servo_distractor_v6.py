...
root=HERE/'results/servo-distractor-06';root.mkdir(exist_ok=False)
rows=[]
for color in ('blue','red'):
    ...
    def spawn(args,*pos,**kw):
        if args[0]=='inkscape':
            svg='<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200"><rect id="target" x="55" y="60" width="12" height="10" fill="red"/><rect id="distractor" x="79" y="60" width="12" height="10" fill="'+color+'"/></svg>'
    ...
    try:
        ...
        target=attrs['target'];other=attrs['distractor'];dx=(float(target['x'])-55)*1.18
        preserved=target['y']=='60' and target['width']=='12' and target['height']=='10' and target['transform'] is None and other==dict(x='79',y='60',width='12',height='10',transform=None)
