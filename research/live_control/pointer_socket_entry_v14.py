"""Expose runtime-resolved OpenTTD framed intents behind socket11."""
...
ENTRY = HERE.parent / "openttd_task/interactive_l_target_guard_v5.py"
domain = sys.argv.pop(1)
if domain != "openttd-framed-intents-v1":
    raise SystemExit("domain must be openttd-framed-intents-v1")
