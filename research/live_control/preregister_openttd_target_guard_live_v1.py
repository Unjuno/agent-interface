"""Freeze a matched fresh OpenTTD target/guard pair before input."""
import hashlib
import json
...
def main():
    ...
    live = ["preregister_openttd_target_guard_live_v1.py", "run_openttd_target_guard_live_v1.py",
    ...
    plan = {"status": "preregistered_before_fresh_openttd_execution",
        "study": "openttd-target-guard-live-01", "order": ["wrong-row", "target"],
        "allocations": [
        ...
        "scope": "matched scripted fresh seed991003 OpenTTD pair with independent engine score; no model call, model authorship, human comparison, token or generalization claim"}
