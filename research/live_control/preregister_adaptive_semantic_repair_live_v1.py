...
OUT = HERE / "adaptive_semantic_repair_live_v1_prereg.json"
SOURCES = [
    "research/live_control/adaptive_semantic_repair_live_v1.py",
    "research/live_control/audit_adaptive_semantic_repair_live_v1.py",
    "research/live_control/test_adaptive_semantic_repair_live_v1.py",
...
def main():
    ...
    output = ROOT / "research/live_control/results/adaptive-semantic-repair-live-01"
    if output.exists(): raise RuntimeError("formal output already exists")
    plan = {
        "schema": "adaptive-semantic-repair-live-prereg-v1",
        "allocation_id": "adaptive-semantic-repair-live-01",
        "output": "research/live_control/results/adaptive-semantic-repair-live-01",
        ...
        "scope": ("One finite no-retry Linux/X11 Chromium integration allocation through "
    ...
    print("adaptive_semantic_repair_live_v1_preregistered")
