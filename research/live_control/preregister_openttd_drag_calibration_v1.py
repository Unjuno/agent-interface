"""Freeze a zero-model OpenTTD drag-coordinate calibration before execution."""
import hashlib
import json
import os
...
SOURCES = ['preregister_openttd_drag_calibration_v1.py', 'probe_openttd_drag_calibration_v1.py',
           'audit_openttd_drag_calibration_v1.py', 'pointer_socket_entry_v8.py', 'durable_submit_v4.py',
...
plan = {
    'study': 'openttd-drag-calibration-01',
    'status': 'PREREGISTERED_BEFORE_EXECUTION',
    'model_calls': 0,
    'offsets_y': [-16, -12, -8, -4, 0, 4],
    'base_points': [{'x': 705, 'y': 240}, {'x': 673, 'y': 256}, {'x': 641, 'y': 272}],
    'fixed_program': 'fresh observe; Shift+F8; key 1; one 600ms three-point drag; observe; independent finish',
    'target_tiles': [977, 978, 979, 1043, 1107],
    'comparison_evidence': {'offset_minus_16': 'v2 model drag changed surrounding 912..915',
                            'offset_zero': 'v4 model drag changed no scored tile'},
