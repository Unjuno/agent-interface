...
ROOT = HERE / "results/timing-envelope-openttd-matched-02"
SOURCES = [
    "preregister_openttd_matched_v2.py",
    "timing_envelope_openttd_matched_driver_v2.py",
    "timing_envelope_openttd_matched_supervisor_v2.py",
...
plan = {
    "study": "timing-envelope-openttd-matched-02",
    "status": "PREREGISTERED_BEFORE_EXECUTION",
    "execution_order": ["adaptive", "fixed-astra", "fixed-luna"],
    "task_allocation": {
    ...
    "interpretation_limit": (
        "the second fixed-order episode per arm is descriptive replication evidence, not a "
