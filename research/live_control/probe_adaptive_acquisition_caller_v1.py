"""Offline retained-record and test-double coverage for the shared caller."""
import hashlib
import json
from pathlib import Path

from adaptive_acquisition_caller_v1 import ModelFailure, run
...
def main():
    ...
    print("adaptive_acquisition_caller_v1_probe_passed")
