...
base=HERE/'results/timing-envelope-openttd-l-08';root=base/arm;control=base/(arm+'-control');control.mkdir(parents=True,exist_ok=False)
def dump(path,value):
...
plan={'scope':'fresh seed-991003 OpenTTD five-tile L objective after pre-action transparency, with bounded post-drag effect evidence','arm':arm,
      'sources':{n:hashlib.sha256((HERE/n).read_bytes()).hexdigest() for n in ['timing_envelope_openttd_l_supervisor_v8.py','timing_envelope_openttd_l_driver_v5.py','timing_envelope_v1.py','timing_envelope_v2.py','semantic_checkpoint_v4.py','openttd_finish_outcome_v1.py','model_pair_runner_v2.py','session_v22.py','openttd_effect_sheet_v1.py','openttd_contact_sheet_v1.py','openttd_drag_effect_v1.py']},
...
driver=subprocess.Popen(['wsl','-d','Ubuntu','--','python3',linux(HERE/'timing_envelope_openttd_l_driver_v5.py'),arm,'timing-envelope-openttd-l-08'],stdout=(control/'driver-stdout.txt').open('wb'),stderr=(control/'driver-stderr.txt').open('wb'))
