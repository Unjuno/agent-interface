...
SOURCES = translated.SOURCES + [
    "preregister_openttd_wrong_anchor_recovery_live_v2.py",
    "run_openttd_wrong_anchor_recovery_live_v2.py",
...
def main():
    ...
    plan = {
        ...
        "study": "openttd-wrong-anchor-recovery-live-02", "seed": 991004,
        "model": "gpt-5.6-luna", "reasoning_effort": "low",
        "task": "open the company finances window after the same requested surface move",
        "fault_injection": {
            "source": ARCHIVED_WRONG.relative_to(HERE).as_posix(),
