...
HERE=Path(__file__).resolve().parent;root=HERE/'results/combined-image-self-use-01'
...
(HERE/'results/combined-image-self-use-audit.json').write_text(json.dumps(report,indent=2)+'\n')
