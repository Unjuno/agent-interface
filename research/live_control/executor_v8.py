...
class Executor:
    ...
    def _run(self,identifier,steps,cancel):
        ...
        try:
            ...
            post_release = None
            if status == 'needs_decision' and decision_reason in ('focus_changed', 'surface_changed') and release.get('verified') is True:
                self.emit(dict(event='input_stopped', id=identifier, decision_reason=decision_reason,
