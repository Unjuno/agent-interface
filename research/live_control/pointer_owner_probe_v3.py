...
from input_owner_v4 import InputOwner
...
def main():
    ...
    sources=[Path(__file__).resolve(),HERE/'input_owner_v4.py',HERE/'lease.py',HERE/'executor_v3.py']
    ...
    try:
        ...
        released('destroyed_surface_releases_hold',l,'focus_changed')
