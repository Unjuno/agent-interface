...
root=HERE/'results/timing-envelope-openttd-04';root.mkdir(exist_ok=False)
def dump(name,value):
...
names=['timing_envelope_openttd_driver_v4.py','durable_submit_v4.py','append_checkpoint_v1.py','received_continuation_v1.py','received_exchange_v2.py','pointer_socket_entry_v3.py','event_socket_v11.py','model_pair_runner_v1.py','openttd_proposal_schema_v4.py','timing_envelope_openttd_supervisor_v4.py','timing_envelope_v1.py','timing_envelope_v2.py','session_v10.py','openttd_contact_sheet_v1.py']
...
p=subprocess.Popen([sys.executable,'-u',str(HERE/'pointer_socket_entry_v3.py'),'openttd','serve','--',
