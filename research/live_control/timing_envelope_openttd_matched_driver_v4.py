...
root=HERE/'results/timing-envelope-openttd-matched-04'/arm;root.mkdir(parents=True,exist_ok=False)
def dump(name,value):
...
names=['timing_envelope_openttd_matched_driver_v4.py','durable_submit_v4.py','append_checkpoint_v1.py','received_continuation_v1.py','received_exchange_v2.py','pointer_socket_entry_v6.py','event_socket_v11.py','model_pair_runner_v2.py','openttd_proposal_schema_v5.py','openttd_finish_outcome_v1.py','timing_envelope_openttd_matched_supervisor_v4.py','timing_envelope_v1.py','timing_envelope_v2.py','session_v22.py','openttd_contact_sheet_v1.py']
dump('plan.json',{'seed_semantics':'canonical save; no RNG override; pre-opened road toolbar','scope':'fresh typed OpenTTD task with pre-opened road toolbar and buffered supervisor TimingEnvelope v2',
     'arm':arm,'sources':{n:hashlib.sha256((HERE/n).read_bytes()).hexdigest() for n in names}})
p=subprocess.Popen([sys.executable,'-u',str(HERE/'pointer_socket_entry_v6.py'),'openttd','serve','--',
