"""Expose combined observe-target candidate behind socket11."""
...
ENTRY = HERE / "interactive_target_handle_chromium_v4.py"
domain = sys.argv.pop(1)
if domain != "chromium-observe-target-v1":
    raise SystemExit("domain must be chromium-observe-target-v1")
