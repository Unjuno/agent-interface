...
H=Path(__file__).resolve().parent;R=H/'results/sampled-effect-calc-01';T=R/'runtime'
...
for snapshot in snapshots:
 ...
 if snapshot['read_status']=='parsed':
  wb=load_workbook(R/snapshot['file'],data_only=True);actual=[wb.active['A1'].value,wb.active['A2'].value];wb.close();assert actual==snapshot['cells']
