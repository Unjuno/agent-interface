...
def main():
    ...
    try:
        hashes={}
        for path in [HERE/'executor_v2.py',HERE/'session_v2.py',HERE.parent/'observation_tiles/tile_transport.py',
        ...
        for line in sys.stdin:
            try:
                ...
                if command['op']=='submit':engine.submit(command['id'],command['steps'],command['expected_sequence'])
