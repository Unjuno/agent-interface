...
def main():
    ...
    bridge = None
    p2 = None
    raw = {"allocation_id": "issue3575-xres-guard-formal-04", "issue": 3575,
    ...
    try:
        ...
        p1_pixel_display = display.Display()
        raw["p1_window_pixels_before_exit"] = window_pixels(p1_pixel_display, p1_info["xid"])
        p1_pixel_display.close()
        raw["p1_pixels_capture_ns"] = time.monotonic_ns()
        ...
        pixels_p1 = raw["p1_window_pixels_before_exit"]
