...
R = H / 'results/query-recovery-controls-02'
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        if case.startswith('matched_'):
            ...
            try:
                ...
                assert str(exc) == ('channel closed; runtime status remains separately unknown' if case == 'closed' else 'unresolved command; read only')
            else:
