...
The complete conversation-local archive `xi2_native_multicontact_lifecycle_v1_complete.tar.gz` is **355,974 bytes**, SHA-256 `12589d9edf0362a697437526f74771c110d11d0fc52472013e2f3045af7ade75`. It contains 485 manifest-bound files: frozen source/construction history, all 28 raw case directories and Xorg/inputtest/XI2 logs, wrapper sidecars, audit, independent verifier and corruption-control tooling/results.
...
A smaller local compact archive containing the exact six frozen source files, all 28 original `result.json` files, report/audit/verifier/control and incident record is **23,550 bytes**, SHA-256 `e95514a764fe7b042329ca526c3717640a9a42518b9942312755931fa48eef32`. The GitHub per-case witness cryptographically binds every original result through its individual SHA-256. No claim is made that GitHub retains the bulk Xorg logs or complete archive bytes.
