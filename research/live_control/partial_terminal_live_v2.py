...
R = H / 'results/partial-terminal-live-02'
...
names = [
    'partial_terminal_live_v2.py', 'delayed_effect_socket_v3.py',
...
dump(R / 'plan.json', {
    'seed': 247, 'deadline_ms': 1100, 'delay_s': 5.0,
...
def episode(label, return_before_expiry):
    ...
    process = subprocess.Popen([
        ...
        '--', '--app', 'chromium', '--seed', '247', '--out', str(runtime_out),
