"""Retain the first prepared-selection failure without retry."""
import hashlib
import json
...
SOURCE = REPO / "results-local/live_control/release-prepared-selection-live-01"
TARGET = HERE / "results/release-prepared-selection-live-01"
...
def main():
    ...
    if (failure["allocation_passed"] is not False or
            failure["retry_count"] != 0 or failure["model_calls"] != 0):
