...
def main():
    root = HERE / 'results/durable-rejection-01'; root.mkdir(exist_ok=False)
    names = ['probe_durable_rejection_v1.py', 'durable_submit_v2.py', 'received_continuation_v1.py', 'received_exchange_v2.py',
             'cause_servo_socket_v6.py', 'cause_servo_interactive_v5.py', 'stopped_socket_v1.py', 'unix_json_deadline.py', 'rejection_identity_v1.py']
    ...
    p = subprocess.Popen([sys.executable, str(HERE / 'cause_servo_socket_v6.py'), 'inkscape', 'serve', '--',
