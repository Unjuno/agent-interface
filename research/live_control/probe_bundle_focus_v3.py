...
root=HERE/'results/bundle-focus-03';root.mkdir(exist_ok=False)
source=HERE/'results/bundle-pair-01/B/bundle/steps.json'
steps=json.loads(source.read_text())
assert len(steps)==9
names=['probe_bundle_focus_v3.py','cause_servo_session_v1.py','cause_session_v1.py','executor_v6.py',
