"""Freeze v3 after v2's preserved visually-flat field-region refusal."""
import hashlib
import json
...
def main():
    ...
    sources = [
        "preregister_compiled_gui_interface_live_v3.py",
        "run_compiled_gui_interface_live_v3.py",
    ...
    plan = {
        ...
        "study": "compiled-gui-interface-live-03", "seed": 991023,
        "execution_order": [
