"""Durable OpenTTD L driver with a scored supervisor stop after the proposal limit."""
...
names=['timing_envelope_openttd_l_driver_v5.py','durable_submit_v4.py','append_checkpoint_v1.py','received_continuation_v1.py','received_exchange_v2.py','pointer_socket_entry_v8.py','event_socket_v11.py','openttd_finish_outcome_v1.py','session_v22.py']
