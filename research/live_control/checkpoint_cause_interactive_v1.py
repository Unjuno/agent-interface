"""Explicit existing patch-servo integration with interruption cause and wake."""
...
from effect_checkpoint_v2 import Checkpoints
        ...
        for line in sys.stdin:
            ...
            try:
                ...
                if command['op']=='submit':engine.submit(command['id'],command['steps'],command['expected_sequence'],command['valid_until_ns'])
                    ...
                    if set(command)-{'op','contract','transport_request_id'}:raise ValueError('unexpected checkpoint fields')
