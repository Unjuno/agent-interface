...
from session_v6 import Backend,suite
...
def main():
    ...
    try:
        hashes={}
        for path in [HERE/'interactive_v7.py',HERE/'session_v6.py',HERE/'input_owner_v2.py',HERE/'session_v5.py',HERE/'input_owner.py',HERE/'executor_v3.py',HERE/'session_v4.py',HERE/'lease.py',HERE.parent/'observation_tiles/tile_transport.py',
