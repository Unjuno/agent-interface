"""Deterministic pixel withholding with explicit planner-facing unknown semantics."""
import copy
import json
...
def render(source, destination, policy, *, source_observation_id):
    ...
    for index, region in enumerate(policy['regions']):
        ...
        draw.rectangle(box, fill=(96, 96, 96), outline=(0, 0, 0), width=2)
    ...
    return {
        'format': 'presented-observation-v1',
