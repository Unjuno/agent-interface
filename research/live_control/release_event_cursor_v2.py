"""Bounded cursor with action-scoped semantic probe delivery."""
import json
import threading
import time
from collections import deque

from release_event_scope_v2 import boundary, validate_scope
...
class EventCursor:
    ...
    def append(self, record):
        ...
        with self.condition:
            ...
            self.sequence += 1
            self.records.append((self.sequence, encoded))
