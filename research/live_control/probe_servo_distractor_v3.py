...
import numpy as np
from session_v18 import Backend,suite
from executor_v3 import Executor
HERE=Path(__file__).resolve().parent
root=HERE/'results/servo-distractor-03';root.mkdir(exist_ok=False)
rows=[]
...
sources=[Path(__file__),HERE/'session_v18.py',HERE/'session_v15.py',HERE/'patch_servo_v2.py',HERE/'visual_anchor_v2.py',HERE/'input_owner_v9.py',HERE/'pointer_reply_v2.py',HERE/'executor_v3.py']
