...
dump(CONTROL / "plan.json", {
    "scope": "fresh seed-991002 no-input negative independent-finish control",
    "sources": {
...
driver = subprocess.Popen(
    ["wsl", "-d", "Ubuntu", "--", "python3", linux(HERE / "timing_envelope_openttd_matched_driver_v5.py"), "negative-control"],
...
try:
    ...
    print("openttd_negative_finish_geometry_v2: PASS")
finally:
