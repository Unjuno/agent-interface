        ...
        with lock:
            ...
            for item in visible:
                ...
                try:print(rendered,flush=True)
                    ...
                    with (args.out/'delivery-flush.jsonl').open('a') as receipt_log:receipt_log.write(json.dumps(receipt)+'\n')
    session=None;server=None;engine=None;output=None;backend=None
    try:
        hashes={}
        for path in [HERE/'interactive_v15.py',HERE/'delivery_ledger.py',HERE/'presentation_v2.py',HERE/'session_v16.py',HERE/'patch_servo.py',HERE/'visual_anchor.py',HERE/'session_v15.py',HERE/'session_v13.py',HERE/'session_v12.py',HERE/'session_v11.py',HERE/'input_owner_v9.py',HERE/'pointer_reply_v2.py',HERE/'session_v9.py',HERE/'input_owner_v5.py',HERE/'presentation.py',HERE/'session_v8.py',HERE/'quiet_window.py',HERE/'session_v7.py',HERE/'session_v6.py',HERE/'input_owner_v2.py',HERE/'session_v5.py',HERE/'input_owner.py',HERE/'executor_v3.py',HERE/'session_v4.py',HERE/'lease.py',HERE.parent/'observation_tiles/tile_transport.py',
