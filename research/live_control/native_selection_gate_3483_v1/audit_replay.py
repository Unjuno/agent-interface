...
def main():
    ...
    releases = [release for row in actions
                for release in row.get("result", {}).get("execution", {}).get("releases", [])]
    releases_ok = bool(releases) and all(
    ...
    core_ok = raw_hashes_ok and lineage_ok and releases_ok and effect and visual_review_attested
    lifecycle = {
