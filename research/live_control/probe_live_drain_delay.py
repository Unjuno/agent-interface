...
HERE=Path(__file__).resolve().parent;out=HERE/'results/live-drain-delay-01';out.mkdir(exist_ok=False)
...
def cli(source,name,boundary,steps):
    ...
    args=[sys.executable,str(HERE/'prepared_exchange_v3.py'),address,str(source),str(root),name,str(stepfile),
...
try:
    ...
    files=[Path(__file__),HERE/'prepared_exchange_v3.py',HERE/'drain_final.py',HERE/'prepare_program.py',HERE/'outcome_wait.py',HERE/'gated_socket_entry_v2.py',HERE/'gated_evaluation_entry_v2.py',HERE/'event_socket_v11.py',HERE/'event_cursor_v5.py',HERE/'request_boundary_v2.py']
