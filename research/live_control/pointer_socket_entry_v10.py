"""Expose the target/guard OpenTTD protocol behind socket11."""
from pathlib import Path
import sys
import event_socket_v11 as bridge

HERE = Path(__file__).resolve().parent
ENTRY = HERE.parent / "openttd_task/interactive_l_target_guard_v1.py"
domain = sys.argv.pop(1)
if domain != "openttd-target-guard":
    raise SystemExit("domain must be openttd-target-guard")
