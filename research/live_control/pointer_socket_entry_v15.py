"""Expose the post-admission binding fault behind socket11."""
...
ENTRY = HERE.parent / "openttd_task/interactive_l_target_guard_v6.py"
domain = sys.argv.pop(1)
if domain != "openttd-framed-binding-fault-v1":
    raise SystemExit("domain must be openttd-framed-binding-fault-v1")
