...
plan={'scope':'matched fresh bounded OpenTTD model-route comparison with buffered process-scoped timing envelope',
      'arm':arm,
      'sources':{n:hashlib.sha256((HERE/n).read_bytes()).hexdigest() for n in ['timing_envelope_openttd_matched_supervisor_v1.py','timing_envelope_openttd_matched_driver_v1.py','timing_envelope_v1.py','timing_envelope_v2.py','openttd_proposal_schema_v5.py','model_pair_runner_v2.py','session_v22.py','openttd_contact_sheet_v1.py']},
...
turns=[]
driver=subprocess.Popen(['wsl','-d','Ubuntu','--','python3',linux(HERE/'timing_envelope_openttd_matched_driver_v1.py'),arm],
