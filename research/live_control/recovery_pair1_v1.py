"""Explicit per-model-call stages for registered pair 1; no automatic task loop."""
import argparse
import hashlib
import json
import time
...
def main():
    ...
    ap.add_argument('stage', choices=['initial', 'prepare', 'recover', 'move', 'finish'])
    ...
    try:
        if args.stage == 'initial':
            ...
            save('execution', {'pair': 1, 'domain': 'inkscape', 'seed': 201, 'depth': 1, 'arm': args.arm,
            ...
            r = act('move-save', read('recover', 'batch'), [
