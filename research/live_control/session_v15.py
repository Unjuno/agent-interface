...
from input_owner_v9 import InputOwner
        ...
        try:
            ...
            for update in range(step['max_updates']):
                ...
                try:
                    ...
                    call('continue_move',dict(owner_id=state['owner_id'],expected_revision=state['revision'],reply_until_ns=offer['reply_until_ns'],x=command['x'],y=command['y']))
                finally:self.replies.clear()
        finally:
