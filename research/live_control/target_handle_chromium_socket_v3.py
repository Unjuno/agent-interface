"""Expose Chromium target-handle alias candidate behind socket11."""
...
ENTRY = HERE / "interactive_target_handle_chromium_v3.py"
domain = sys.argv.pop(1)
if domain != "chromium-target-handle-v3":
    raise SystemExit("domain must be chromium-target-handle-v3")
