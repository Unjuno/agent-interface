"""Versioned backend using the typed multi-predicate semantic registry."""
import sys
import time
...
from semantic_probe_runtime_v2 import SemanticProbeRegistry, reconcile_probe_artifact
...
class Backend(Previous):
    ...
    def snapshot(self, identifier, index):
        ...
        probe = self.semantic_probes.probe(identifier, index, sequence, capture, frame)
