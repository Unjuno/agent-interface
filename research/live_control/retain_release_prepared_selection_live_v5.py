...
HERE=Path(__file__).resolve().parent;REPO=HERE.parents[1];SOURCE=REPO/"results-local/live_control/release-prepared-selection-live-05";TARGET=HERE/"results/release-prepared-selection-live-05";PREREG=HERE/"release_prepared_selection_live_v5_prereg.json"
