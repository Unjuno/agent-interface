                    ...
                    if command['op']=='submit':
                        ...
                        if finish_after:
                            def finalize_episode():
                                ...
                                final_done.wait()
                                outcome=finalize(final_id,engine.close,lambda:suite.evaluate(args.app,output,goal),emit)
