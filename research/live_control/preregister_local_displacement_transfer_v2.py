"""Freeze a cross-OS relative-path transfer of the first authored condition."""
import hashlib
import json
...
def main():
    ...
    sources = [
        "preregister_local_displacement_transfer_v2.py",
        "run_local_displacement_transfer_v2.py", "run_local_displacement_transfer_v1.py",
    ...
    plan = {
        ...
        "correction": "v1 failed before input because its frozen Windows absolute author path was not WSL-readable; v2 stores a path relative to this script directory",
