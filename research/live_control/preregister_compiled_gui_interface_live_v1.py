"""Freeze the first compiled-interface live mechanics pair before GUI start."""
import hashlib
import json
...
def main():
    ...
    sources = [
        "preregister_compiled_gui_interface_live_v1.py",
        "run_compiled_gui_interface_live_v1.py",
    ...
    plan = {
        ...
        "study": "compiled-gui-interface-live-01", "seed": 991021,
        "execution_order": [
