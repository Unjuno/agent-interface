"""Unpromoted desktop cause candidate: session v9 semantics, owner10/executor4."""
...
def main():
    ...
    try:
        hashes={}
        for path in [HERE/'cause_interactive_v2.py',HERE/'cause_session_v1.py',HERE/'input_owner_v10.py',HERE/'executor_v5.py',HERE/'lease_cause_v1.py',HERE/'lease_cause_v2.py',HERE/'presentation.py',HERE/'session_v8.py',HERE/'quiet_window.py',HERE/'session_v7.py',HERE/'session_v6.py',HERE/'input_owner_v2.py',HERE/'session_v5.py',HERE/'input_owner.py',HERE/'executor_v3.py',HERE/'session_v4.py',HERE/'lease.py',HERE.parent/'observation_tiles/tile_transport.py',
        ...
        suite.write_json(args.out/'fixture.json',{'display':session.name,'scope':'private fault injection fixture only'})
        ...
        emit(dict(event='ready',app=args.app,task=task,goal=goal,presentation=args.presentation,operations=['submit','cancel','clock','finish']))
