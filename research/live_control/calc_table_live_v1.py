...
if stage=='initial':
    save('plan',dict(seed=225,app='calc',scope='One live self-use with executor v6, full receipt and state table; no fault injection or speed comparison',
        model_tokens=None,verified_model_id=None,sources={n:digest((HERE/n).read_bytes()) for n in
        ['calc_table_live_v1.py','cause_servo_socket_v2.py','cause_servo_interactive_v2.py','executor_v6.py',
