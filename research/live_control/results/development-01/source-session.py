...
class Backend:
    ...
    def validate(self,steps):
        ...
        for step in steps:
            ...
            elif op!='observe': raise ValueError('unsupported operation')
...
def main():
    ...
    try:
        hashes={}
        for path in [HERE/'executor.py',HERE/'session.py',HERE.parent/'observation_tiles/tile_transport.py',
        ...
        for line in sys.stdin:
            try:
                ...
                if command['op']=='submit':engine.submit(command['id'],command['steps'])
