...
def probe(out,seed,leased):
    script='session_v4.py' if leased else 'session_v2.py'
...
if __name__=='__main__':
    ...
    names=('lease.py','executor_v3.py','session_v4.py','probe_lease_v2.py','test_lease.py')
    ...
    try:
        for i,seed in enumerate((900301,900302)):
