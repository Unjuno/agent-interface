...
out={'schema':'inkscape-atspi-session-discovery-path-lifetime-audit-v1','pass':not errors,'decision':dec,'cases':len(rows),'errors':errors,'arms':{a:sum(1 for r in rows if r.get('arm')==a) for a in set(sched)}}
