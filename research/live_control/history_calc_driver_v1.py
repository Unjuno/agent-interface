...
label=sys.argv[1]
assert label in ('history-abba-1-last','history-abba-2-all','history-abba-3-all','history-abba-4-last')
...
names=['history_calc_driver_v1.py','durable_submit_v4.py','append_checkpoint_v1.py','received_continuation_v1.py','received_exchange_v2.py','cause_servo_socket_v7.py','model_pair_runner_v1.py','calc_proposal_schema_v1.py','history_calc_supervisor_v1.py']
