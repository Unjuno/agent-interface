...
root=HERE/'results/servo-distractor-01';root.mkdir(exist_ok=False)
rows=[]
for color in ('blue','red'):
    ...
    try:
        _,output,_=suite.prepare(s,'inkscape',991012,'unused');backend=Backend(s,out,emit);engine=Executor(backend,emit);backend.snapshot('initial',0)
...
sources=[Path(__file__),HERE/'session_v17.py',HERE/'session_v15.py',HERE/'patch_servo.py',HERE/'visual_anchor.py',HERE/'input_owner_v9.py',HERE/'pointer_reply_v2.py',HERE/'executor_v3.py']
