...
OUT=HERE/'results/checkpoint-confirmation-01';OUT.mkdir(exist_ok=False)
summaries=[]
for mode in ('review_then_confirm',):
    out=OUT/mode;out.mkdir();root=out/'runtime';responses=[]
    proc=subprocess.Popen([sys.executable,'-u',str(HERE/'confirmation_socket_entry_v3.py'),
...
files=[Path(__file__),HERE/'confirmation_socket_entry_v3.py',HERE/'confirmation_browser_entry_v3.py',
    HERE/'prepared_exchange_v6.py',HERE/'effect_checkpoint.py',HERE/'request_boundary_v3.py',HERE/'event_cursor_v6.py',HERE/'event_socket_v13.py']
