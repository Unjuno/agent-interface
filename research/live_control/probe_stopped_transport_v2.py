...
root=HERE/'results/stopped-transport-02';root.mkdir(exist_ok=False)
names=['probe_stopped_transport_v2.py','stopped_transport_entry_v1.py','stopped_transport_fixture_v1.py',
