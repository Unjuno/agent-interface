...
def main():
    ...
    sources=[HERE/n for n in names]+[Path(__file__).resolve(),HERE.parent/'observation_gating/gui_suite.py',HERE.parent/'observation_tiles/tile_transport.py',HERE.parent/'observation_tiles/image_artifact.py',HERE.parent/'real_apps_v1/real_app_suite_v1.py']
