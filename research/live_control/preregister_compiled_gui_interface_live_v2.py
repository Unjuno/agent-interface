"""Freeze v2 after v1's preserved pre-input batched-mint rejection."""
import hashlib
import json
...
OUT = HERE / "results/compiled-gui-interface-live-02"
...
def main():
    ...
    sources = [
        "preregister_compiled_gui_interface_live_v2.py",
        "run_compiled_gui_interface_live_v2.py",
    ...
    plan = {
        ...
        "study": "compiled-gui-interface-live-02", "seed": 991022,
        "execution_order": [
