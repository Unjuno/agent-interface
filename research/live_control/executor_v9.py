        ...
        try:
            ...
            if status == 'completed':
                try:
                    ...
                    status = 'cancelled'
            interruption = cancel.interruption_snapshot()
