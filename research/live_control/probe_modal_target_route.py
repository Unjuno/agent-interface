...
out=HERE/'results/modal-target-route-01';out.mkdir(exist_ok=False)
plan=dict(cases=[route+'_'+fault for route in ('key','click') for fault in ('normal','focus','move')],injection='focus Tab twice or window move at entry to Previous.execute after guard passes',
