...
out=HERE/'results/outcome-fallback-live-02';out.mkdir(exist_ok=False)
...
try:
    ...
    sources=[Path(__file__),HERE/'failed_evaluation_entry_v2.py',HERE/'failed_socket_entry_v2.py',HERE/'outcome_wait.py',HERE/'outcome_fallback_v2.py',HERE/'event_socket_v11.py',HERE/'event_cursor_v5.py',HERE/'request_boundary_v2.py',HERE/'finalization_v3.py']
