"""Freeze an unchanged, opposite-order replication of the authored transfer."""
import hashlib
import json
...
def main():
    ...
    sources = [
        "preregister_local_displacement_transfer_v4.py",
        "run_local_displacement_transfer_v4.py", "parse_local_displacement_author_v1.py",
    ...
    plan = {
        ...
        "order_change": "v3 target-to-partial; v4 partial-to-target to expose order/focus sensitivity",
        ...
        "prior_authored_output_sha256": sha(HERE / "results/local-displacement-transfer-03/authored-postcondition.json"),
