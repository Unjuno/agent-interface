...
def main():
    node, cli, image, prompt_file, working, output, tier = sys.argv[1:]
    ...
    args[args.index('-C'):args.index('-C')] = (['--enable','fast_mode','-c','service_tier="fast"'] if tier=='fast' else ['--disable','fast_mode'])
    plan = dict(requested_tier=tier, observed_service_tier=None, args=args, requested_model='gpt-5.6-luna', requested_effort='low',
