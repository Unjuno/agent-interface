"""Audit the first actual redaction study, including declared pixel geometry."""
import hashlib
import json
import statistics
import sys
...
R = H / 'results/redacted-observation-01'
C = H / 'results/redacted-observation-controls-01'
M = H / 'results/redaction-cost-01'
...
assert difference_bbox == (60, 264, 249, 292)
declared_box = tuple(plan['redaction_box'])
box_edge_semantics_explicit = False
...
report = {
    ...
    'redacted': {'calls': 4, 'expected_unknown': 4,
                 'input_tokens_per_call': 9401, 'runner_s': runners['redacted']},
    'input_token_delta_per_call': 99,
    ...
    'box_edge_semantics_explicit': box_edge_semantics_explicit,
    ...
    'promotion': False,
    'promotion_blocker': 'v1 region box does not declare edge semantics; actual PIL change extends through right/bottom coordinates',
