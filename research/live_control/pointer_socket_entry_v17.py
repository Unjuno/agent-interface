"""Expose the combined observe-target OpenTTD task behind socket11."""
...
ENTRY = HERE.parent / "openttd_task/interactive_l_observe_target_v1.py"
domain = sys.argv.pop(1)
if domain != "openttd-observe-target-v1":
    raise SystemExit("domain must be openttd-observe-target-v1")
