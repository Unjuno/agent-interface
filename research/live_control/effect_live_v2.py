...
def main():
    ...
    def query(q):
        ...
        return reply
    if stage == 'initial':
        names = ['effect_interactive_v1.py', 'effect_fault_backend_v1.py', 'effect_checkpoint_v1.py', 'effect_socket_v2.py', 'effect_command_once_v1.py', 'effect_live_v2.py', 'cause_servo_session_v1.py', 'cause_servo_interactive_v1.py',
        ...
        save('plan', {'sources': {n: digest((HERE / n).read_bytes()) for n in names},
                     'allocation': 'one fresh Inkscape seed 219; environment replacement before first servo feedback; no implicit retries',
