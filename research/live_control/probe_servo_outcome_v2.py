...
import numpy as np
from session_v17 import Backend,suite
from executor_v3 import Executor
from patch_servo import PatchServo
HERE=Path(__file__).resolve().parent
root=HERE/'results/servo-outcome-02';root.mkdir(exist_ok=False)
allrows=[]
for offset in (0,40):
...
sources=[Path(__file__),HERE/'patch_servo.py',HERE/'visual_anchor.py',HERE/'session_v17.py',HERE/'session_v15.py',HERE/'input_owner_v9.py',HERE/'pointer_reply_v2.py',HERE/'executor_v3.py']
