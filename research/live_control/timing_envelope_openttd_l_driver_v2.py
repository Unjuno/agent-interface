"""Corrected durable proposal driver for a future OpenTTD L allocation."""
...
study=sys.argv[2] if len(sys.argv)>2 else 'timing-envelope-openttd-l-02'
...
names=['timing_envelope_openttd_l_driver_v2.py','durable_submit_v4.py','append_checkpoint_v1.py','received_continuation_v1.py','received_exchange_v2.py','pointer_socket_entry_v8.py','event_socket_v11.py','openttd_finish_outcome_v1.py','session_v22.py']
dump('plan.json',{'seed_semantics':'byte-pinned seed-991003 save; five-tile L objective; closed toolbar','scope':'corrected fresh OpenTTD L task driver','arm':arm,'study':study,'sources':{n:hashlib.sha256((HERE/n).read_bytes()).hexdigest() for n in names}})
