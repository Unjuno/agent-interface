                    ...
                    if command['op']=='submit':
                        ...
                        if finish_after:
                            def finalize_episode():
                                final_done.wait()
                                engine.close()
                                emit(dict(event='independent_evaluation',final_program=final_id,**suite.evaluate(args.app,output,goal)))
