"""Freeze the pre-action transparent OpenTTD L allocation before execution."""
import hashlib
import json
import os
...
ROOT = HERE / 'results/timing-envelope-openttd-l-05'
SOURCES = [
    'preregister_openttd_l_v5.py',
    'openttd_negative_finish_l_v5.py',
    'audit_openttd_l_v5.py',
    'openttd_finish_outcome_v1.py',
    'timing_envelope_openttd_l_driver_v4.py',
    'timing_envelope_openttd_l_supervisor_v5.py',
    ...
    'results/timing-envelope-openttd-l-04/audit.json',
...
plan = {
    'study': 'timing-envelope-openttd-l-05',
    ...
    'positive_path': {
        ...
        'interface_change': 'apply state-aware ensure_trees_transparent before ready/turn 1, add zero model boundaries, and offer no repeat view method',
    ...
    'comparison_baseline': 'v4 same seed/task/model/checkpoint used three post-drag toggles, stopped at turn 12, task false, 198746 input tokens',
