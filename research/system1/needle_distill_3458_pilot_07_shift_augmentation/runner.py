"""Paired pilot-07: same compact Needle, alternate training mixture only."""
import hashlib
import json
import math
import random
...
def training_rows(seed,augmented):
    ...
    if augmented:
        ...
        classes[1]=torch.cat((classes[1][:1024],shifted_class(1,1024,seed+40)),0)
...
def generate_result():
    ...
    return {"allocation":"needle-intent-distill-3458-pilot-07-targeted-shift-augmentation",
            "issue":3918,"training_contract":{"architecture":"6->16->16->3 tanh MLP",
