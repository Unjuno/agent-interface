"""Paired pilot-08: same compact Needle, stratified training mixture only."""
import hashlib
import json
import math
import random
...
def generate_result():
    ...
    return {"allocation":"needle-intent-distill-3458-pilot-08-stratified-correct",
            "issue":4462,"training_contract":{"architecture":"6->16->16->3 tanh MLP",
