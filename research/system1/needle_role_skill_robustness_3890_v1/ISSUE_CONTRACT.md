...
- Use ten fresh deterministic seeds `100000, 100100, 100200, 100300, 100400, 100500, 100600, 100700, 100800, 100900`; do not reuse construction or formal seeds from #3778/#3780/#3890, nor any LoRA seed. The initial candidate 3792 was retired before training when construction checks detected collisions with #3890's retained `seed+1` through `seed+12` component RNG stream; the new range is spaced by 100 and is disjoint from every retained #3890 component stream.
