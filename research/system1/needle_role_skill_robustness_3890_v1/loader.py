...
def validate(path,expected):
    ...
    if obj["provenance"]!={"allocation":"needle-role-skill-robustness-3890-v1","predecessor_issue":3890,"seed":expected["seed"],"family":"synthetic-role-adapter-v1"}: raise ValueError("provenance")
