...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument('--arm',choices=['control','inject_fd'],required=True); ap.add_argument('--scenario',choices=['stable','B_change'],required=True); ap.add_argument('--case-id',required=True); ap.add_argument('--out',required=True); args=ap.parse_args()
