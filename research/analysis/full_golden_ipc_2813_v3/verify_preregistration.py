"""Verify the v3 historical-source successor gate without execution."""
import hashlib, json
...
def main() -> int:
    ...
    result={"status":"PASS_TASK1_ROUTE_PREFLIGHT" if not mismatches else "STOP_SOURCE_HASH_MISMATCH","issue":2813,"successor":"full_golden_ipc_2813_v3","mismatches":mismatches,"authority_granted":False,"gui_operations":0,"task_execution":False}
