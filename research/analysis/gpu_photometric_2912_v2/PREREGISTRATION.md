...
Issue #4463, successor to #2912. First source images are public retained Chromium fixture artifacts; prior CPU/nearest-neighbor outcomes are unchanged.
...
Source-hash amendment before model allocation: the first frozen runner used the Windows `core.autocrlf=true` worktree SHA-256 `5af3901c0d579bf1e65ff9d36931fa033f116de5f66a156670d8d650851497b0` for the JSON manifest. The canonical Git blob/LF SHA-256 is `dc86185fdec9a1605548861519fa6777c1153948c032c49a7fa1557160c77bc8`; the manifest content and all six image hashes are unchanged. Runner and auditor now normalize CRLF to LF before hashing/parsing, and report the canonical Git-blob-equivalent digest. This was corrected and committed before any model allocation.
...
**T.** Freeze base commit `d9776a90662e1d7f901a025395aa27e28d9d4d00`, canonical Git-blob/LF image-label manifest SHA-256 `dc86185fdec9a1605548861519fa6777c1153948c032c49a7fa1557160c77bc8`, and all six image hashes in `research/analysis/local_model_2912_image_manifest.json`. The runner/auditor normalize CRLF to LF before verifying this digest. Train only on tasks 1, 2, 4, 5; hold out complete task-3 (A) and task-6 (B) screenshots. Evaluate each held-out source at original brightness and deterministic 0.85x/1.15x pixel intensity, round-half-up and clamp [0,255].
