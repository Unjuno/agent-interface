...
Owned path: `research/analysis/target_belief_admission_v2/**`

Repair A2: ID001 stopped before Python loaded the study because the local source workspace was missing. ID002 restores the exact GitHub-frozen ID001 capsule and changes only allocation/publication identity plus this chronology. Thresholds, profiles, corpus, candidate/oracle/comparator and decision gates are unchanged.
