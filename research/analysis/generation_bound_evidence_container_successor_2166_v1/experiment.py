...
def main():
    ...
    out={'decision':'PASS_CONTAINER_REVALIDATION_SCOPED','cases':5,'statuses':[r['status'] for r in rows],'stale_control':'PASS','reuse_control':'PASS','provenance_control':'PASS','model':0,'x11':0,'input':0,'digest':digest}
