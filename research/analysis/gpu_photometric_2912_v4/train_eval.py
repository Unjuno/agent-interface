...
def pooling_matrix_sha256():
    pool = DeterministicAdaptiveAvgPool2d((25, 40), (8, 10))
    return sha256(pool.height_weights.numpy().tobytes() + pool.width_weights.numpy().tobytes())
...
class DeterministicAdaptiveAvgPool2d(nn.Module):
    """Separable fixed-matrix implementation of adaptive average pooling bins."""
...
class TinyGrounder(nn.Module):
    def __init__(self):
        ...
        self.features = nn.Sequential(
            ...
            DeterministicAdaptiveAvgPool2d((25, 40), (8, 10)), nn.Flatten(),
...
def main():
    ...
    result = {
        "format": "gpu-photometric-2912-v4-result-v1",
        "source_commit": "21dd6a26dbd9f5cb4a6e11b1060902799a76a733",
        "cnn_feature_map_shape": [BATCH, 16, 25, 40],
        ...
        "pooling_operator": "deterministic_adaptive_avg_pool2d_separable_hw25x40_v1",
        "pooling_matrix_sha256": pooling_matrix_sha256(),
