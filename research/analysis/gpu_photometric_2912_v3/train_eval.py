...
def pooling_matrix_sha256():
    pool = DeterministicAdaptiveAvgPool2d((40, 25), (8, 10))
...
class DeterministicAdaptiveAvgPool2d(nn.Module):
    ...
    def __init__(self, input_size=(40, 25), output_size=(8, 10)):
        super().__init__()
...
class TinyGrounder(nn.Module):
    def __init__(self):
        ...
        self.features = nn.Sequential(
            ...
            DeterministicAdaptiveAvgPool2d((40, 25), (8, 10)), nn.Flatten(),
...
def main():
    ...
    result = {
        ...
        "source_commit": "9e3ee7ea02b27e935a50130a0be45e9938a4dfdb",
