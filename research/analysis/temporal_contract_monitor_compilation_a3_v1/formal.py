...
TASK='TEMPORAL-CONTRACT-MONITOR-COMPILATION-A3-20260918-003'
TIMES=tuple(range(5));PARAMS=(1,2,3)
FULL_TRACES=1062624;FULL_PREFIXES=5144980
LABELS={
...
def main():
    ...
    checks={
      'full_corpus_exact':tt==FULL_TRACES and pp==FULL_PREFIXES,
      'mismatch0':mm==0,
    ...
    decision='PASS_TEMPORAL_CONTRACT_MONITOR_COMPILATION_A3_SCOPED' if all(checks.values()) else 'FAIL_TEMPORAL_MONITOR_SEMANTICS_A3'
