"""Verify v6 source pins without execution."""
import hashlib,json
...
def main()->int:
 ...
 r={"status":"PASS_TASK1_ROUTE_PREFLIGHT" if not m else "STOP_SOURCE_HASH_MISMATCH","issue":2813,"successor":"full_golden_ipc_2813_v6","mismatches":m,"authority_granted":False,"gui_operations":0,"task_execution":False};print(json.dumps(r,indent=2,sort_keys=True));return 0 if not m else 1
