...
5. The repaired development build passed 12 tests including a deterministic 10,000-program C1 round-trip stress corpus.
6. The repaired development source cross-built stdlib-only binaries for Linux amd64/arm64, Windows amd64, macOS amd64/arm64.

The failures above are retained because they expose a real portability hazard: semantic JSON equivalence is weaker than byte-level wire compatibility.
