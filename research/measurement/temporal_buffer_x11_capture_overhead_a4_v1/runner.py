...
def main():
    ...
    base_display=140 if args.construction else 150
    for i in range(pairs):
        ...
        rows.append(pair)
    result={'construction':args.construction,'formal':not args.construction,'formal_invocations':0 if args.construction else 1,'reruns':0,'pairs':rows,'platform':platform.platform(),'python':platform.python_version(),'grants_input_authority':False,'task':'TEMPORAL-BUFFER-X11-CAPTURE-OVERHEAD-20260918-004'}
