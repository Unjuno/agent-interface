...
TASK='DECISION-POLICY-CACHE-XTERM-PARENT-ENV-A2-20260918-002'
...
def run_case(root,arm,sched,case_id):
    ...
    parent_display=os.environ.get('DISPLAY');parent_xauthority=os.environ.get('XAUTHORITY');parent_env_scoped=False
    try:
