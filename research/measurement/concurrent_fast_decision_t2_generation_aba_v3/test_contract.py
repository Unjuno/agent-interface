...
class HarnessTranslation(unittest.TestCase):
 def test_forged_generation_keyword_translation_equivalence(self):
  from oracle import Oracle
  c=Candidate(); o=Oracle()
  c.frontier_request('A'); o.req('A'); c.observe('A','CLEAR'); o.obs('A','CLEAR'); c.prepare('A','d'); o.prep('A','d')
  self.assertEqual(c.try_admit('A','d',True,claimed_generation=999)['admit'], o.admit('A','d',True,claimed=999))
