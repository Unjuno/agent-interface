...
def main():
    ...
    result={'task':'TEMPORAL-SPECULATION-K1-BUDGET-PRESSURE-20260918-001','seed':SEED,'formal_invocations':1,'reruns':0,'cases':len(cases),'large':large,'large_wall_ns':large_wall,'live_rows':live,'live_summary':live_summary,'authority_grants':0,'model_calls':0,'gui_actions':0,'task_input_actions':0}
