...
TASK='CONCURRENT-FAST-DECISION-T1-X11-EDGE-TRIGGERED-ACTUATION-20260918-005'
    ...
    try:
        ...
        def ctl():
            ...
            for off in range(0,FRONTIER,SAMPLE):
                ...
                if emit:
                    ab,ae=send_f8(cd,k); sends.append({'send_begin_ns':ab,'send_end_ns':ae,'nominal_sample_offset_ns':off}); row['send_index']=len(sends)-1
                prev_state=st
