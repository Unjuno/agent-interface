...
def case(role="good"):
    if role=="good": return [{"role":"PHYSICAL_ACTUATION","plan_id":"p1","actuation_id":"a1","t_ns":100},
      {"role":"TASK_EFFECT","plan_id":"p1","actuation_id":"a1","t_ns":200,"effect_id":"e1","scored":True,"scorer_source":"independent"}]
